...
var base = Rebase.createClass({
  apiKey: "AIzaSyDIN5Bd0G6KtghKNNgSIDgdCFQ3lSKGBbs",   // replace with your Firebase application's API key
  authDomain: "final-668be.firebaseapp.com",
  databaseURL: "https://final-668be.firebaseio.com/", // replace with your Firebase application's database URL
})
...
var App = React.createClass({
  ...
  componentDidMount: function() {
    ...
    base.syncState('/movies', { context: this, state: 'view', asArray: true })
  },
  render: function() {
    return (
      <div>
